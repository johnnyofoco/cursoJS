/*
 * Filter serve para filtrar elementos do array retorno um novo array.
 * Filter tbm recebe uma função como parâmetro
 * Porém seu retorno apenas trará os elementos que seja verdadeiros para a condição processada na função.
 */
